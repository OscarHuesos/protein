...
//  void apartar_memoria_atomo_lista();
...
public:
  char Nombre_res[4], Nombre_cad[3]; //, name_1[2], name_all[15];  // 3 naming styles
  ...
  //void set_identificador_cadena(int i) { chainSeqlNo=i; }
...
void leer(char *file); //read coordinates
