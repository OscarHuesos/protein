...
//  residuos_en_proteina[kkk].contactos1=residuos_en_proteina[kkk].contactos1+At1;
  //printf("%d contactos 1\n",residuos_en_proteina[kkk].contactos1 );
break;
}
}
}
...
//int cc=No_atomos_por_cadena[a];
//for(int in=0;in<cc;in++){
//printf("cad %d res %d  b %.2f  atomo id %d tipo %s  area %.2f \n",residuos_en_proteina[w].id_cadena ,residuos_en_proteina[w]. Id_Res , residuos_en_proteina[w].atomos_en_residuo[a].b ,residuos_en_proteina[w].atomos_en_residuo[a].No_Atomo , residuos_en_proteina[w].atomos_en_residuo[a].Tipo,residuos_en_proteina[w].atomos_en_residuo[a].area_atomo);
//printf("cadena %d contactos por atomo %f \n",residuos_en_proteina[w].id_cadena ,residuos_en_proteina[w].atomos_en_residuo[a].No_Atomos2);
}
}


//for(int a=0; a< cadena;a++){
//int cc=No_atomos_por_cadena[a];
//for(int in=0;in<cc;in++){
//printf("cadena %d areas por atomo %f \n",residuos_en_proteina[a].id_cadena ,residuos_en_proteina[a].atomos_en_residuo[in].area_atomo);
//printf("cadena %d contactos por atomo %f \n",residuos_en_proteina[a].id_cadena ,residuos_en_proteina[a].atomos_en_residuo[in].No_Atomos2);
//}
//}
...
//    prue=residuos_en_proteina[k].No_atomos;
//  for (int p = 0; p < prue; ++p){
//    if(){
//    carry=residuos_en_proteina[k].atomos_en_residuo[p].b;
//    break;
//    }
